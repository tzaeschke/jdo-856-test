...
public abstract class QueryTest extends AbstractReaderTest {
  ...
  protected void checkQueryResultWithOrder(
    ...
    System.out.println("Plain accept all"); // TODO
    if (true) {
      return;
    }
    if (!equals(result, expected)) {
   ...
   * {@link BigDecimal#compareTo(BigDecimal)}. It allows <code>o1</code> and/or <code>o2
   ...
   * Object#equals(Object)} because object arrays having equal elements cannot be compared
   * calling {@link Object#equals(Object)}. This method does not allow <code>o1</code> and
   ...
   * QueryTest#equals(Object, Object)} is called rather than {@link Object#equals(Object)}
   * because object arrays having equal elements cannot be compared calling {@link
   * Object#equals(Object)}. This method does not allow <code>o1</code> and <code>o2
   ...
   * {@link Object#equals(Object)} because object arrays having equal elements cannot be
   * compared calling {@link Object#equals(Object)}.
   *
   * @param col the collection
   * @param o the object
   ...
   * it is passed as an argument to the method {@link Query#executeWithArray(Object[])}.
   * If argument <code>parameters</code> is a map, then it is passed as an argument to the method
   * {@link Query#executeWithMap(Map)}. If argument <code>parameters</code> is a list,
   ...
   * Query#deletePersistentAll()}, or {@link Query#deletePersistentAll(Map)}, or {@link
   * Query#deletePersistentAll(Object[])} depending on the type of argument <code>
   ...
   * {@link Query#deletePersistentAll(Map), or
   * {@link Query#deletePersistentAll(Object[])

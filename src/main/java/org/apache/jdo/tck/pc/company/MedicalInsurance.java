...
public class MedicalInsurance extends Insurance implements IMedicalInsurance {
   ...
   */
  public MedicalInsurance(long insid, String carrier, String planType) {
    super(insid, carrier);
   ...
   * @param planType The planType.
   */
  public MedicalInsurance(long insid, String carrier, IEmployee employee, String planType) {
  ...
  /**
   * Returns a String representation of a <code>MedicalInsurance</code> object.
   *
   * @return a String representation of a <code>MedicalInsurance</code> object.
   */
  @Override

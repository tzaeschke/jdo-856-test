...
public class QDepartment extends PersistableExpressionImpl<Department> implements PersistableExpression<Department>
{
    ...
    public final QEmployee employeeOfTheMonth;
    ...
    public QDepartment(PersistableExpression parent, String name, int depth)
    {
        ...
        if (depth > 0)
        {
            this.company = new QCompany(this, "company", depth-1);
        }
        else
        {
            this.company = null;
        ...
        if (depth > 0)
        {
            this.employeeOfTheMonth = new QEmployee(this, "employeeOfTheMonth", depth-1);
        }
        else
        {

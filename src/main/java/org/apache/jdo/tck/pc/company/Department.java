...
public class Department
  ...
  private transient List<IMeetingRoom> meetingRooms =
      new ArrayList<>(); // element type is MeetingRoom
   ...
   */
  public Department(long deptid, String name, ICompany company, IEmployee employeeOfTheMonth) {
    this.deptid = deptid;
    this.name = name;
    this.company = (Company) company;
   ...
   * fields of the other Department.
   *
